 ...
 *
 */
public class ImportCSV extends BaseModule {

	static final String PROPERTY_CSV_FILENAME = "CSV_FILENAME";

	public ImportCSV(String propertiesFilename ) throws Exception 
	{
	...
	public static void main(String[] args) throws Exception {
		ImportCSV module = new ImportCSV(args[0]);
		module.run();
	}
