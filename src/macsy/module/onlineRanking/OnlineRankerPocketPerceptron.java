 ...
 * The algorithm saves the best weight vector that has occured so far and uses it
 ...
 *
 */
public class OnlineRankerPocketPerceptron extends BaseModule {
    ...
    public OnlineRankerPocketPerceptron(String propertiesFilename) throws Exception {
    ...
    private void trainingProcedure(List<DataPoint> list_x_i,
            ...
            boolean performance, Results learningResults, String header)
            throws Exception {
    ...
    private void Training(DataPoint x_i, DataPoint x_j,
        ...
        //increment the number of total training samples
        total_tp++;
    }
    ...
    public static void main(String[] args) throws Exception {
        OnlineRankerPocketPerceptron module = new OnlineRankerPocketPerceptron(args[0]);
    ...
    /**
     * @param total_tp the total_tp to set
     */
