package macsy.module.onLineLearningPerceptronOnWords;
...
import macsy.lib.VocabularyOnWords;
...
public class OnLineLearningPerceptronOnWords extends BaseModule {
	...
	private VocabularyOnWords w_voc  = null;
	
	public OnLineLearningPerceptronOnWords(String propertiesFilename ) throws Exception {
	 ...
	 */
	private double calculateDotExtendedWX(VocabularyOnWords w_voc, Map<Integer,Double> x) throws InterruptedException
	{
		double weight = 0;
	...
	public void runModuleCore() throws Exception 
	{
		...
		w_voc  = new VocabularyOnWords(this.getProperty(PROPERTY_TXT_FILENAME));
	...
	public static void main(String[] args) throws Exception {
		OnLineLearningPerceptronOnWords module = new OnLineLearningPerceptronOnWords(args[0]);
		module.run();
	}
}
