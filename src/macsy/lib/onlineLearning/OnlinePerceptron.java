...
/**
 * This class implements the Perceptron algorithm. It is a type of linear classifier, i.e. a
 * classification algorithm that makes its predictions based on a linear predictor function
 * combining a set of weights with the feature vector. An update is made when an error is seen.
 ...
 *
 * * @author Panagiota Antonakaki, Tom Welfare
 **/
public class OnlinePerceptron implements OnlineLearning {
    ...
    public OnlinePerceptron(String wFileName) throws Exception {
    ...
    public void train(DataPoint sample) throws Exception {
        ...
        //System.out.println("Real label: " + sample.getRealLabel());
        //System.out.println("Predicted label: " + sample.getPredictedLabel());
     ...
     * @throws Exception
     */
    private void update_exponentialMovingAverageError(boolean wasThereError)
            throws Exception {
        if (wasThereError) {
    ...
    public void saveLog(String filename) throws IOException {
        ...
        String str = desiredPrecision + "\t"
                ...
                + N_hat_Pos + "\t"
                + N_hat_Neg + "\t"
                + getStatisticsMatrix()[TP] + "\t"
                + getStatisticsMatrix()[FP] + "\t"
                + getStatisticsMatrix()[TN] + "\t"
                + getStatisticsMatrix()[FN] + "\t"
                + AUC_value + "\t"
                + N_overall;
    ...
    private void statsGetAUC(DataPoint sample) throws Exception {
        ...
        AUC_object.expAUC_addPoint(AUC_object.getLast_pos_score() > AUC_object.getLast_neg_score());
